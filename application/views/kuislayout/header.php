                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= site_url('Kuis') ?>" aria-expanded="false">
                                <span>
                                    <i class="ti ti-layout-dashboard"></i>
                                </span>
                                <span class="hide-menu">Regular D4</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= site_url('Kuis') ?>" aria-expanded="false">
                                ...
                                <span class="hide-menu">Magister</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="<?= site_url('Kuis') ?>" aria-expanded="false">
                                ...
                                <span class="hide-menu">Ahli Madya</span>
                            </a>
                        </li>
                    </ul>
                ...
                <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-end">
                    <li class="nav-item dropdown">
                        <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                            ...
                            <img src="<?= base_url('assets/assetbaru/images/profile/default.jpg')?>" alt="" width="35" height="35"
